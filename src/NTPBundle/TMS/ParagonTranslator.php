...
class ParagonTranslator{
    ...
    public function convertData(){
        $query = $this->em
                ->createQuery("INSERT INTO NTPBundle:Schedule () routeNo,s.startTimePlanned,s.departTimePlanned,s.arrivalTimePlanned,s.finishTimePlanned,s.dutyTimePlanned,s.routeDistance,s.routeTime,s.kmsPlanned "
